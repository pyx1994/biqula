var nowpage = 1, perpage = 50, maxpage = 1, orderway, thispage = 1;
...
function updatecache(){
	$.ajax({
		...
		success: function(data){
			...
			$('#loading-tip').html('<span class="ptm-text-success"><i class="ptm-iconfont fa fa-check-circle"></i> 机器人已为您抓取最新章节</span>');
			$('#loading-tip1').html('新');
